// DDraw.h: interface for the CDDrawDevice class.
//
//////////////////////////////////////////////////////////////////////
...
public:
	...
	BOOL CalcSpriteClipArea(INT_VECTOR2* pivOutSrcStart, INT_VECTOR2* pivOutDestStart, INT_VECTOR2* pivOutDestSize, const RECT& srcRect, const INT_VECTOR2* pDestPos, const INT_VECTOR2* pBufferSize);
	...
	BOOL DrawSpriteFlip(int screenX, int screenY, const CImageData* pImgData, const RECT& srcRect);
